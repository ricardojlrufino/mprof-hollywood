...
class FilmesControllerTest < ActionController::TestCase
  ...
  test "should create filme" do
    assert_difference('Filme.count') do
      post :create, filme: { conteudo: @filme.conteudo, imagem: @filme.imagem, titulo: @filme.titulo, url: @filme.url }
    end
  ...
  test "should update filme" do
    patch :update, id: @filme, filme: { conteudo: @filme.conteudo, imagem: @filme.imagem, titulo: @filme.titulo, url: @filme.url }
    assert_redirected_to filme_path(assigns(:filme))
  end
